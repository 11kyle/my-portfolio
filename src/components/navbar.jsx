...
export default function Navbar() {
  ...
  return (
    ...
    <div className={classNames(
      ...
      <nav className="flex justify-between items-center max-w-5xl h-20 px-6 md:px-8 mx-auto">
        <div>
          <a 
            href="/"
            className={classNames(
              isScrolled ? "hover:text-primary-orange" : "hover:text-white",
              "font-bold text-2xl md:text-3xl font-exo-2 text-primary-black"
            )}
          >
            kj
          </a>
        ...
        <div className="flex flex-row items-center gap-x-6">
          <a className="align-middle" href="https://github.com/11kyle">
            <svg 
              className={classNames(
                isScrolled ? "hover:fill-primary-orange" : "hover:fill-white",
                "fill-primary-black"
              )}
