    ...
    <div id="about" className="scroll-m-20">
      <section 
        ...
        className={classNames(
          ...
          "trainsition duration-700 pt-20 pb-10"
        )}
      >
        <SectionHeading 
          title="About" 
